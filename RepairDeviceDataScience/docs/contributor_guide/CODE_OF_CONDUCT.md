# Code of conduct for `RepairDeviceDataScience`

Contributors to this repository hosted by `Annu-Bboxx` are expected to follow the
...
- "Project", we mean this `RepairDeviceDataScience` GitHub repository;
- "Maintainer", we mean the `Annu-Bboxx` organisation owners; and
- "Leadership", we mean both `Annu-Bboxx` organisation owners, line managers, and other
  leadership within the BBOXX.
...
[a.kajla@bboxx.co.uk][email-address]. All complaints will be
...
[email-address]: mailto:a.kajla@bboxx.co.uk
